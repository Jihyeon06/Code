var config =
{
    ...
    */
    loadingMessages:
    [
        "[Tip] FREE RP는 한가한 RP 이며, 입문 하기 좋은 RP입니다.",
		"[Tip] 프리월드는 새로운 개념의 FREE RP 입니다.",
        "[Tip] 프리월드 디스코드 가입은 필수입니다.",
        "[Tip] 피리#8235으로 피드백을 주시면 빠르게 처리해드립니다.",
		"[Tip] 경고 5회시 서버에서 차단 처리 됩니다.",
		"[Tip] FREE RP는 메타게이밍, 파워게이밍이 가능합니다.",
		"[Tip] 수많은 사유지는 부동산에게 구매가 가능합니다.",
		"[Tip] FREE RP는 과도한 친목은 제재하나, 어느정도의 친목은 인정됩니다.",
    ],

    /*
        Rotate the loading message every 5000 milliseconds (default value).
    */
    loadingMessageSpeed: 5 * 1500,
